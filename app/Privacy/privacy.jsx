            ...
            <div className="space-y-8">
              <section className="bg-gray-50 p-6 rounded-lg border-l-4 border-indigo-500">
                ...
                <p className="leading-relaxed">
                  We collect personal information (like name, email, and contact
                  details) when you interact with our services. We also gather
                  anonymous data such as IP addresses, browser type, and usage
              ...
              <section className="bg-gray-50 p-6 rounded-lg border-l-4 border-indigo-500">
                ...
                <p className="leading-relaxed">
                  ...
                  with you, respond to your inquiries, and provide personalized
                  experiences. We never sell your personal data to third
                  parties.
                </p>
              </section>
              ...
              <section className="bg-gray-50 p-6 rounded-lg border-l-4 border-indigo-500">
                ...
                <p className="leading-relaxed">
                  ...
                  safety of your data. However, no system is 100% secure. We
                  encourage you to protect your credentials and use secure
                  connections.
                </p>
              </section>
              ...
              <section className="bg-gray-50 p-6 rounded-lg border-l-4 border-indigo-500">
                ...
                <p className="leading-relaxed">
                  ...
                  payment processors. These tools have their own privacy
                  practices, which we recommend you review.
                </p>
              </section>
              ...
              <section className="bg-gray-50 p-6 rounded-lg border-l-4 border-indigo-500">
                ...
                <p className="leading-relaxed">
                  You have the right to request access to your data, update your
                  information, or request deletion. Please contact us if you
                  have any privacy concerns or requests.
                </p>
              </section>
              ...
              <section className="bg-gray-50 p-6 rounded-lg border-l-4 border-indigo-500">
                ...
                <p className="leading-relaxed">
                  We may update our privacy policy from time to time. Updates
