...
export default function TeamSection() {
  ...
  const teamMembers = [

    {
      ...
      image: gurwinder,
      social: [
        { icon: "twitter", url: "https://x.com/gurwinx369?t=TGXh-GFJhWPljb4BRqbfWg&s=09", color: "bg-blue-400" },
        { icon: "instagram", url: "https://www.instagram.com/x_gurwinxr?igsh=cDlrdWVnOHY4bHV0", color: "bg-pink-600" },
