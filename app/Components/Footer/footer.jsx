...
const SocialIcon = ({ path, href, ariaLabel, bgColor = "bg-indigo-100", hoverBg = "hover:bg-indigo-600" }) => (
  <Link 
    href={href} 
          ...
          <motion.div className="lg:col-span-2" variants={itemVariants}>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Transforming digital concepts into scalable, reliable SaaS products with speed and innovation. 
            ...
            <div className="mb-8">
              <h4 className="text-indigo-600 font-medium mb-4">Connect with us</h4>
            ...
            >
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-gray-50 border-2 border-gray-200 text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300"
                  required
                  disabled={isLoading}
                />
              ...
              <motion.button
                type="submit"
                className="w-full px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-indigo-500/25 disabled:opacity-50 disabled:cursor-not-allowed"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                disabled={isLoading}
              >
        ...
        >
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
            <div className="text-gray-500 text-sm">
              © {new Date().getFullYear()} Innosphere. All rights reserved. Made with ❤️ in India
            </div>
