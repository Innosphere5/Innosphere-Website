...
import { Mail, Phone, MapPin, Clock, Send, CheckCircle, Users, Zap, Shield, Rocket } from 'lucide-react';
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@innosphere.com</p>
                    <p className="text-gray-600">projects@innosphere.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Usually within 2-4 hours</p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8">
              <div className="mb-8">
                ...
                <p className="text-gray-600">
                  Tell us about your idea and let's discuss how we can bring it to life with our expertise in fast SaaS development.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-indigo-100 mb-8 max-w-2xl mx-auto">
              Join 100+ successful founders who've transformed their ideas into thriving SaaS platforms with Innosphere.
            </p>
